...
interface Props {
  ...
  /** Fishery polygons from species exposure panel (optional). */
        ...
        <Layer
          ...
          paint={{
            "line-color": [
              "match",
              ["get", "risk"],
              "confirmed_iuu", RISK_COLOR.confirmed_iuu,
              "high_risk", RISK_COLOR.high_risk,
              "suspect", RISK_COLOR.suspect,
              "safe", RISK_COLOR.safe,
              "#7a8398",
            ],
            "line-width": 1,
            "line-opacity": 0.45,
