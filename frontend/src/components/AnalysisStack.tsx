...
export function AnalysisStack({
  ...
  return (
    <div className="pointer-events-none absolute inset-y-4 right-4 z-20 flex w-[min(380px,calc(100%-2rem))] flex-col gap-3 overflow-y-auto overscroll-contain [scrollbar-gutter:stable]">
